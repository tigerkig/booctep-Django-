...
$(document).ready(function () {
  ...
  $('.pop-button').on('click', function () {
    $(this).toggleClass('is-active');
    var courseiddata = $(this).attr("data-id");
    var user_id = userid;
      ...
      if ($(this).hasClass('is-shifted')) {
            ...
            if ($(".cartitem").length == 0) {
              ...
              <ul class="shopping-cart-items-2">
                  <li class="cart-row-2">
                      ...
                      <span class="item-name" style="color: grey;">لا توجد دورات بعد.</span>
                  </li>
              </ul>
        ...
        $.post(urlcart, { student: user_id, course: courseiddata }, function (res) {
          ...
          if ($(".cartitem").length == 0) {
            ...
            var html = `<div class="shopping-cart-header cartzerovanish">
                ...
                <ul class="shopping-cart-items-2 cartzeroopen" style="display: none;">
                    <li class="cart-row-2">
                        ...
                        <span class="item-name" style="color: grey;">آسف لا توجد دورات حتى الآن في عربة التسوق الخاصة بك</span>
                    </li>
                </ul>
                <ul class="shopping-cart-items cartitemparent">
                  <li class="cart-row cartitem" data-id="${courseiddata}">
                      ...
                      <span style="cursor: pointer;" data-id="${courseiddata}" onclick="deleteFromCartDropDown(this)">
                        <i class="fa fa-trash" aria-hidden="true"></i>
                      </span>
                  </li>
                </ul>
                <a href="/showcartlist" class="button primary-button is-raised cartzerovanish">Show CartList</a>`;
            $("#cart-parent").html(html)
          } else {
            ...
            $(".cartitem[data-id='" + courseiddata + "']").append(`<span class="item-meta" style="margin-left:auto !important"><span class="meta-info"></span></span>`);
            $(".cartitem[data-id='" + courseiddata + "']").append(`<span style="cursor: pointer;" data-id="${courseiddata}" onclick="deleteFromCartDropDown(this)">
                                                <i class="fa fa-trash mr-auto" style="" aria-hidden="true"></i>
                                            </span>`);
          }
          $(".carttotalcourses").empty();
          $(".carttotalcourses").append("" + (cartcountAvailable + 1));
      ...
      if ($(this).hasClass('is-shifted')) {
        $.post(urlfav, { student: user_id, course: courseiddata }, function (res) {
          ...
          if ($(".favitem").length == 0) {
            ...
            var html = `<div class="shopping-cart-header">
                  ...
                  <a class="button primary-button is-raised"
                      style="background:#DCDCDC !important;border:1px solid #D2D2D2 ;color: #7F7F7F;;cursor:not-allowed;">عرض الصفحة المفضلة
                  </a>`;
        ...
        $.post(urlfav, { student: user_id, course: courseiddata }, function (res) {
          ...
          if ($(".favitem").length == 0) {
            ...
            var html = `<div class="shopping-cart-header favzerovanish">
                            ...
                            <ul class="shopping-cart-items favitemparent">
                                <li class="cart-row favitem" data-id="${courseiddata}">
                                    ...
                                    <span class="item-meta">
                                      <span class="item-name"><a href="#">${favdropdownNameAdd}</a></span>
                                      <span class="meta-info">
                                    ...
                                    <span style="cursor: pointer;" data-id="${courseiddata}"
                                       onclick="deleteFromFavDropDown(this)">
                                      <i class="fa fa-trash" aria-hidden="true"></i>
                                    </span>
                                </li>
                            </ul>
                            <a href="/showfavlist" class="button primary-button is-raised favzerovanish">Show FavList</a>`;
            $("#fav-parent").html(html)
          } else {
            ...
            $(".favitem[data-id='" + courseiddata + "']").append(`<span class="item-meta" style="margin-left:auto !important"><span class="meta-info"></span></span>`);
            $(".favitem[data-id='" + courseiddata + "']").append(`<span style="cursor: pointer;" data-id="${courseiddata}" onclick="deleteFromFavDropDown(this)">
                                                <i class="fa fa-trash mr-auto" style="" aria-hidden="true"></i>
                                            </span>`);
          }
          $(".favtotalcourses").empty();
